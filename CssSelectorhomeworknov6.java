...
public class CssSelectorhomeworknov6 {
	...
	public static void main(String[] args) {
		public class Facebook_CssSelector {
			...
			public void PersonalInformation() throws Exception {
				...
				WebElement ReEnterEmailAddress = driver
						.findElement(By.cssSelector("input[name=reg_email_confirmation__]"));
				...
				WebElement Gender = driver
						.findElement(By.xpath("//div[@id='custom_gender_container']/preceding::input[2]"));
